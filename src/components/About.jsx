...
export default function About() {
  return (
    // Tight padding keeps the layout unified without overlapping components
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="max-w-4xl mx-auto bg-gradient-to-br from-gray-50 via-gray-50/50 to-white p-6 rounded-2xl border border-gray-100 shadow-sm mb-12">
          <p className="text-gray-700 text-base md:text-lg leading-relaxed text-center font-medium">
            ...
            contributing to the FieldEquip enterprise SaaS platform[cite: 1]. Skilled in Java, Spring Boot, REST APIs, MongoDB, 
            and MySQL, with a strong foundation in SDLC and backend development[cite: 1]. Passionate about building 
            scalable, high-quality software and continuously enhancing technical expertise[cite: 1].
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-10 items-start">
          ...
          {/* LEFT & CENTER COLUMNS: PROFESSIONAL EXPERIENCE, TRAINING, & EDUCATION (2/3 Width) */}
                  ...
                  <div className="bg-gray-50 p-6 rounded-2xl border border-gray-100 shadow-sm">
                    <div className="flex flex-col sm:flex-row justify-between items-start mb-3 gap-2">
                      <div>
                        ...
                        <p className="text-green-600 font-semibold text-sm">Bursys Technologies | FieldEquip[cite: 1]</p>
                      </div>
                      <div className="flex flex-col items-end text-xs text-gray-500 font-medium sm:text-right">
                        <span className="flex items-center gap-1 bg-green-100 text-green-800 px-2.5 py-1 rounded-full font-semibold">
                          <FaCalendarAlt /> June 15, 2026 – Present[cite: 1]
                        </span>
                      </div>
                    </div>
                    
                    <ul className="space-y-2 text-gray-600 text-sm leading-relaxed list-disc pl-4">
                      <li>Developing and maintaining backend services using Java and Spring Boot[cite: 1].</li>
                      <li>Building REST APIs and implementing business logic[cite: 1].</li>
                      <li>Working with MongoDB for data storage and retrieval[cite: 1].</li>
                      <li>Debugging issues and collaborating with cross-functional teams to deliver product features[cite: 1].</li>
                    </ul>
                  </div>
                </div>
              </div>
                  ...
                  <div className="bg-gray-50 p-6 rounded-2xl border border-gray-100 shadow-sm">
                    <div className="flex flex-col sm:flex-row justify-between items-start mb-3 gap-2">
                      <div>
                        ...
                        <p className="text-green-600 font-semibold text-sm">JSpiders[cite: 1]</p>
                      </div>
                      <div className="text-xs text-gray-500 font-medium space-y-1 sm:text-right">
                        <p className="flex items-center sm:justify-end gap-1"><FaMapMarkerAlt /> Bengaluru[cite: 1]</p>
                        <p className="flex items-center sm:justify-end gap-1"><FaCalendarAlt /> 2025[cite: 1]</p>
                      </div>
                    </div>
                    <ul className="space-y-1.5 text-gray-600 text-xs leading-relaxed list-disc pl-4">
                      <li>Hands-on training in Java Full Stack Development following SDLC practices[cite: 1].</li>
                      <li>Core Java, JDBC, Servlets, JSP, Spring Boot, REST APIs[cite: 1].</li>
                      <li>HTML, CSS, JavaScript, SQL, and database integration[cite: 1].</li>
                    </ul>
                  </div>
                </div>
              </div>
                  ...
                  <div className="bg-gray-50 p-6 rounded-2xl border border-gray-100 shadow-sm">
                    <div className="flex flex-col sm:flex-row justify-between items-start mb-3 gap-2">
                      <div>
                        ...
                        <p className="text-green-600 font-semibold text-sm">Computer Science and Engineering[cite: 1]</p>
                      </div>
                      <div className="text-xs text-gray-500 font-medium space-y-1 sm:text-right">
                        <p className="flex items-center sm:justify-end gap-1"><FaMapMarkerAlt /> Chandigarh University, Punjab[cite: 1]</p>
                        <p className="flex items-center sm:justify-end gap-1"><FaCalendarAlt /> 2021 - 2025[cite: 1]</p>
                      </div>
                    </div>
                    <div className="flex justify-between items-center bg-white px-4 py-2 rounded-xl border border-gray-100">
                      ...
                      <span className="text-xs font-bold bg-green-50 text-green-700 px-2.5 py-1 rounded">CGPA: 7.35[cite: 1]</span>
                    </div>
                  </div>
                </div>
              </div>
          ...
          {/* RIGHT COLUMN: SIDEBAR METRICS & CERTIFICATIONS (1/3 Width) */}
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    {["Core Java", "Advanced Java", "Spring Framework", "Spring Boot", "REST APIs", "JWT Authentication"].map((tag) => (
                      <span key={tag} className="text-xs font-medium bg-white text-gray-700 px-2.5 py-1 rounded-md border border-gray-200/60 shadow-xs">{tag}[cite: 1]</span>
                    ))}
                  </div>
                </div>
