          ...
          <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-8 mb-6">
            ...
            <div>
              ...
              <div className="flex space-x-5 text-3xl">
                ...
                <a
                  href="https://www.linkedin.com/in/shekharkumar14?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"
                  target="_blank"
                  rel="noreferrer"
                ...
                <a
                  href="https://www.instagram.com/shekhar_prasad07?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw=="
                  target="_blank"
                  rel="noreferrer"
